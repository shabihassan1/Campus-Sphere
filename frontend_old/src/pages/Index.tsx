...
const Index = () => {
  return (
    <PageLayout>
      ...
      <div className="py-16 md:py-24">
        <div className="md:max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="rounded-xl overflow-hidden shadow-2xl order-1 md:order-2 relative">
              <img 
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
                <div className="flex items-center">
                  ...
                  <p className="text-white font-medium">Top-rated campus community platform</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Testimonials */}
      <div className="bg-gradient-to-r from-primary-600 to-blue-700 text-white py-16 px-4 rounded-xl mb-16">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">What Students Say</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20 hover:bg-white/20 transition-colors">
      ...
      <div className="text-center py-16 max-w-4xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Join Campus Sphere?</h2>
